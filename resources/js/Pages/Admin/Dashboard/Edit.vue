...
const form = useForm({
  ...
  price: props.certification.price,
  start_date: props.certification.start_date,
  end_date: props.certification.end_date,
});



let submit = () => {
    form.put(route('certifications.update', props.certification.id), {resetOnSuccess: true });
  }
</script>
